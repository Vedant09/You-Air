/** ISO 3166-1 alpha-2 → alpha-3 mapping (used for GeoBoundaries API) */
export const ISO2_TO_ISO3: Record<string, string> = {
  ...
  SZ: 'SWZ', ET: 'ETH', FI: 'FIN', FR: 'FRA', GA: 'GAB',
  ...
  KZ: 'KAZ', KE: 'KEN', XK: 'XKX', KW: 'KWT', KG: 'KGZ',
  ...
  TG: 'TGO', TT: 'TTO', TN: 'TUN', TR: 'TUR', TM: 'TKM',
  UG: 'UGA', UA: 'UKR', AE: 'ARE', GB: 'GBR', US: 'USA',
  UY: 'URY', UZ: 'UZB', VU: 'VUT', VA: 'VAT', VE: 'VEN',
