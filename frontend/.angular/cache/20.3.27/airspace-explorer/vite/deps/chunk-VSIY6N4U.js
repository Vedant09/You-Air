...
var ProbeLog = class extends BaseLog {
  ...
  _updateConfiguration(configuration) {
    const currentConfiguration = this._storage.config[this.id] || __spreadValues({}, DEFAULT_LOG_CONFIGURATION);
    this._storage.setConfiguration({
      [this.id]: __spreadValues(__spreadValues({}, currentConfiguration), configuration)
    });
  }
};
...
function selectivelyMerge(props, defaultProps) {
  const mergedProps = __spreadValues({}, defaultProps);
...
var Buffer = class _Buffer extends Resource {
  ...
  constructor(device, props) {
    const deducedProps = __spreadValues({}, props);
   ...
   */
  clone(props) {
    return this.device.createBuffer(__spreadValues(__spreadValues({}, this.props), props));
  }
  ...
  static defaultProps = __spreadProps(__spreadValues({}, Resource.defaultProps), {
    usage: 0,
...
var TEXTURE_FORMAT_TABLE = __spreadValues(__spreadValues({}, TEXTURE_FORMAT_COLOR_DEPTH_TABLE), TEXTURE_FORMAT_COMPRESSED_TABLE);
...
function getTextureFormatInfoUsingTable(format) {
  ...
  delete info.blend;
  delete info.store;
  const formatInfo = __spreadProps(__spreadValues({}, info), {
    format,
...
var DeviceFeatures = class {
  ...
  *[Symbol.iterator]() {
    yield* __yieldStar(this.features);
  }
  has(feature) {
...
var Device = class _Device {
  ...
  constructor(props) {
    this.props = __spreadValues(__spreadValues({}, _Device.defaultProps), props);
...
var Luma = class _Luma {
  static defaultProps = __spreadProps(__spreadValues({}, Device.defaultProps), {
    type: "best-available",
    adapters: void 0,
  ...
  createDevice() {
    return __async(this, arguments, function* (props_ = {}) {
      const props = __spreadValues(__spreadValues({}, _Luma.defaultProps), props_);
      const adapter = this.selectAdapter(props.type, props.adapters);
      if (!adapter) {
        throw new Error(ERROR_MESSAGE);
      }
      if (props.waitForPageLoad) {
        yield adapter.pageLoaded;
      }
      return yield adapter.create(props);
    });
  }
  /**
  ...
  attachDevice(handle, props) {
    return __async(this, null, function* () {
      ...
      return yield adapter?.attach?.(handle, props);
    });
  }
  /**
...
var CanvasSurface = class _CanvasSurface {
  ...
  constructor(props) {
    this.props = __spreadValues(__spreadValues({}, _CanvasSurface.defaultProps), props);
    props = this.props;
...
var Texture = class _Texture extends Resource {
   ...
   */
  clone(size) {
    return this.device.createTexture(__spreadValues(__spreadValues({}, this.props), size));
  }
  ...
  copyImageData(options) {
    const _a = options, { data, depth } = _a, writeOptions = __objRest(_a, ["data", "depth"]);
    this.writeData(data, __spreadProps(__spreadValues({}, writeOptions), {
  ...
  _normalizeCopyImageDataOptions(options_) {
    const _a = options_, { data, depth } = _a, writeOptions = __objRest(_a, ["data", "depth"]);
    const options = this._normalizeTextureWriteOptions(__spreadProps(__spreadValues({}, writeOptions), {
      depthOrArrayLayers: writeOptions.depthOrArrayLayers ?? depth
    }));
    return __spreadValues({ data, depth: options.depthOrArrayLayers }, options);
  }
  _normalizeCopyExternalImageOptions(options_) {
    ...
    const options = __spreadValues(__spreadValues(__spreadValues(__spreadValues({}, _Texture.defaultCopyExternalImageOptions), mipLevelSize), size), optionsWithoutUndefined);
  ...
  _normalizeTextureReadOptions(options_) {
    ...
    const mipLevel = optionsWithoutUndefined.mipLevel ?? 0;
    const mipLevelSize = this._getMipLevelSize(mipLevel);
    const options = __spreadValues(__spreadValues(__spreadValues({}, _Texture.defaultTextureReadOptions), mipLevelSize), optionsWithoutUndefined);
    options.width = Math.min(options.width, mipLevelSize.width - options.x);
    options.height = Math.min(options.height, mipLevelSize.height - options.y);
  ...
  _normalizeTextureWriteOptions(options_) {
    ...
    const mipLevel = optionsWithoutUndefined.mipLevel ?? 0;
    const mipLevelSize = this._getMipLevelSize(mipLevel);
    const options = __spreadValues(__spreadValues(__spreadValues({}, _Texture.defaultTextureWriteOptions), mipLevelSize), optionsWithoutUndefined);
    options.width = Math.min(options.width, mipLevelSize.width - options.x);
    options.height = Math.min(options.height, mipLevelSize.height - options.y);
    options.depthOrArrayLayers = Math.min(options.depthOrArrayLayers, mipLevelSize.depthOrArrayLayers - options.z);
    ...
    case "all":
      ...
      for (let lineNum = 1; lineNum <= lines.length; lineNum++) {
        ...
        while (log2.length > currentMessageIndex && currentMessage.lineNum === lineNum) {
          ...
          if (message2) {
            formattedLog += formatCompilerMessage(message2, lines, message2.lineNum, __spreadProps(__spreadValues({}, options), {
              inlineSource: false
            }));
          }
        }
      ...
      while (log2.length > currentMessageIndex) {
        const message2 = log2[currentMessageIndex++];
        if (message2) {
          formattedLog += formatCompilerMessage(message2, [], 0, __spreadProps(__spreadValues({}, options), {
            inlineSource: false
          }));
        }
      }
...
var Shader = class _Shader extends Resource {
  ...
  constructor(device, props) {
    props = __spreadProps(__spreadValues({}, props), { debugShaders: props.debugShaders || device.props.debugShaders || "errors" });
    super(device, __spreadValues({ id: getShaderIdFromProps(props) }, props), _Shader.defaultProps);
  ...
  debugShader() {
    return __async(this, null, function* () {
      ...
      const messages = yield this.getCompilationInfo();
...
var Framebuffer = class _Framebuffer extends Resource {
  ...
  clone(size) {
    ...
    return this.device.createFramebuffer(__spreadProps(__spreadValues(__spreadValues({}, this.props), size), {
      colorAttachments,
...
var SharedRenderPipeline = class extends Resource {
  ...
  constructor(device, props) {
    super(device, props, __spreadProps(__spreadValues({}, Resource.defaultProps), {
      handle: void 0,
      vs: void 0,
      fs: void 0,
      varyings: void 0,
...
var PipelineFactory = class _PipelineFactory {
  static defaultProps = __spreadValues({}, RenderPipeline.defaultProps);
  ...
  createRenderPipeline(props) {
    ...
    const allProps = __spreadValues(__spreadValues({}, RenderPipeline.defaultProps), props);
    ...
    if (!pipeline) {
      ...
      pipeline = this.device.createRenderPipeline(__spreadProps(__spreadValues({}, allProps), {
  ...
  createComputePipeline(props) {
    ...
    const allProps = __spreadValues(__spreadValues({}, ComputePipeline.defaultProps), props);
    const cache = this._computePipelineCache;
    const hash = this._hashComputePipeline(allProps);
    let pipeline = cache[hash]?.resource;
    if (!pipeline) {
      pipeline = this.device.createComputePipeline(__spreadProps(__spreadValues({}, allProps), {
...
var ShaderFactory = class _ShaderFactory {
  static defaultProps = __spreadValues({}, Shader.defaultProps);
  ...
  createShader(props) {
    ...
    if (!cacheEntry) {
      const resource = this.device.createShader(__spreadProps(__spreadValues({}, props), {
...
function normalizeBindingsByGroup(shaderLayout, bindingsOrBindGroups) {
  ...
  if (areBindingsGrouped(bindingsOrBindGroups)) {
    ...
    return Object.fromEntries(Object.entries(bindGroups2).map(([group, bindings]) => [Number(group), __spreadValues({}, bindings)]));
  }
  const bindGroups = {};
...
var CommandEncoder = class _CommandEncoder extends Resource {
  ...
  resolveTimeProfilingQuerySet() {
    return __async(this, null, function* () {
      ...
      const results = yield this._timeProfilingQuerySet.readResults({
        firstQuery: 0,
        queryCount
      });
  ...
  _applyTimeProfilingToPassProps(props) {
    ...
    return __spreadProps(__spreadValues({}, passProps), {
...
var CommandBuffer = class _CommandBuffer extends Resource {
  ...
  static defaultProps = __spreadValues({}, Resource.defaultProps);
};
...
function makeShaderBlockLayout(uniformTypes, options = {}) {
  const copiedUniformTypes = __spreadValues({}, uniformTypes);
...
function createBrowserContext(canvas, props, webglContextAttributes) {
  ...
  const webglProps = __spreadProps(__spreadValues({
...
function loadSpectorJS(props) {
  return __async(this, null, function* () {
    if (!globalThis.SPECTOR) {
      try {
        yield loadScript(props.debugSpectorJSUrl || DEFAULT_SPECTOR_PROPS.debugSpectorJSUrl);
      } catch (error) {
...
function initializeSpectorJS(props) {
  props = __spreadValues(__spreadValues({}, DEFAULT_SPECTOR_PROPS), props);
...
function loadWebGLDeveloperTools() {
  return __async(this, null, function* () {
    if (isBrowser() && !globalThis.WebGLDebugUtils) {
      ...
      yield loadScript(WEBGL_DEBUG_CDN_URL);
    }
  });
}
...
function getDebugContext(gl, props) {
  ...
  globalThis.WebGLDebugUtils.init(__spreadValues(__spreadValues({}, GLEnum), gl));
...
var WEBGLBuffer = class extends Buffer {
  ...
  constructor(device, props = {}) {
    ...
    device._setWebGLDebugMetadata(this.handle, this, {
      spector: __spreadProps(__spreadValues({}, this.props), { data: typeof this.props.data })
    });
  ...
  mapAndWriteAsync(_0) {
    return __async(this, arguments, function* (callback, byteOffset = 0, byteLength = this.byteLength - byteOffset) {
      const arrayBuffer2 = new ArrayBuffer(byteLength);
      yield callback(arrayBuffer2, "copied");
  ...
  mapAndReadAsync(callback, byteOffset = 0, byteLength) {
    return __async(this, null, function* () {
      const data = yield this.readAsync(byteOffset, byteLength);
      return yield callback(data.buffer, "copied");
    });
  }
...
var WEBGLShader = class extends Shader {
  ...
  getCompilationInfo() {
    return __async(this, null, function* () {
      yield this._waitForCompilationComplete();
...
${source}`;
  ...
  _waitForCompilationComplete() {
    return __async(this, null, function* () {
      const waitMs = (ms) => __async(null, null, function* () {
        return yield new Promise((resolve) => setTimeout(resolve, ms));
      });
      const DELAY_MS = 10;
      if (!this.device.features.has("compilation-status-async-webgl")) {
        yield waitMs(DELAY_MS);
        return;
      }
      const { gl } = this.device;
      for (; ; ) {
...
var WEBGLTextureView = class extends TextureView {
  ...
  texture;
  constructor(device, props) {
    super(device, __spreadValues(__spreadValues({}, Texture.defaultProps), props));
    this.device = device;
    this.gl = this.device.gl;
    this.handle = null;
...
var WEBGLTexture = class extends Texture {
  ...
  constructor(device, props) {
    ...
    this.view = new WEBGLTextureView(this.device, __spreadProps(__spreadValues({}, this.props), { texture: this }));
    Object.seal(this);
  }
  destroy() {
    if (this.handle) {
  ...
  createView(props) {
    return new WEBGLTextureView(this.device, __spreadProps(__spreadValues({}, props), { texture: this }));
  }
  setSampler(sampler = {}) {
  ...
  writeBuffer(buffer, options_ = {}) {
    ...
    const glParameters = __spreadProps(__spreadValues({
  ...
  writeData(data, options_ = {}) {
    ...
    const glParameters = !this.compressed ? __spreadProps(__spreadValues({
      [3317]: this.byteAlignment
    }, unpackRowLength !== void 0 ? { [3314]: unpackRowLength } : {}), {
      [32878]: options.rowsPerImage
    }) : {};
  ...
  _readColorTextureLayers(options, memoryLayout, readLayer) {
    ...
    const glParameters = __spreadValues({
...
function mergeShaderLayout(baseLayout, overrideLayout) {
  const mergedLayout = __spreadProps(__spreadValues({}, baseLayout), {
    ...
    bindings: baseLayout.bindings.map((binding) => __spreadValues({}, binding))
  });
...
var WEBGLSharedRenderPipeline = class extends SharedRenderPipeline {
  ...
  _linkShaders() {
    return __async(this, null, function* () {
      ...
      yield this._waitForLinkComplete();
      ...
      switch (status) {
        ...
        default:
          ...
          switch (this.vs.compilationStatus) {
            ...
            case "pending":
              yield this.vs.asyncCompilationStatus;
              this.vs.debugShader();
              break;
            case "success":
              break;
          ...
          switch (this.fs?.compilationStatus) {
            ...
            case "pending":
              yield this.fs.asyncCompilationStatus;
              this.fs.debugShader();
              break;
            case "success":
              break;
...
var WEBGLRenderPass = class extends RenderPass {
  ...
  constructor(device, props) {
    ...
    this.setParameters(__spreadValues({ viewport }, this.props.parameters));
...
function polyfillWebGL1Extensions(gl) {
  ...
  const boundExtensions = __spreadProps(__spreadValues({}, WEBGL1_STATIC_EXTENSIONS), {
...
var WebGLAdapter = class extends Adapter {
  ...
  constructor() {
    super();
    Device.defaultProps = __spreadValues(__spreadValues({}, Device.defaultProps), DEFAULT_SPECTOR_PROPS);
  }
   ...
   */
  attach(_0) {
    return __async(this, arguments, function* (gl, props = {}) {
      const { WebGLDevice: WebGLDevice2 } = yield import("./webgl-device-Q7O3GNMJ.js");
      ...
      return new WebGLDevice2(__spreadProps(__spreadValues({}, props), {
        _handle: gl,
        createCanvasContext: __spreadValues({ canvas: gl.canvas, autoResize: false }, createCanvasContext)
      }));
    });
  }
  create() {
...
var WEBGLQuerySet = class extends QuerySet {
    ...
    return __async(this, null, function* () {
      ...
      if (this.props.type === "timestamp") {
        ...
        for (let pairIndex = startPairIndex; pairIndex <= endPairIndex; pairIndex++) {
          const duration = yield this._consumeTimestampPairResult(pairIndex);
      ...
      return [yield this._consumeQueryResult(this._occlusionQuery)];
    });
  }
  readTimestampDuration(beginIndex, endIndex) {
    return __async(this, null, function* () {
      if (this.props.type !== "timestamp") {
      ...
      const result = yield this._consumeTimestampPairResult(this._getTimestampPairIndex(beginIndex));
  ...
  _consumeTimestampPairResult(pairIndex) {
    return __async(this, null, function* () {
      const pair = this._timestampPairs[pairIndex];
      if (!pair || pair.completedQueries.length === 0) {
      ...
      try {
        return yield this._consumeQueryResult(query);
      } finally {
        this.device.gl.deleteQuery(query.handle);
      }
    });
...
var WebGLDevice = class _WebGLDevice extends Device {
  ...
  constructor(props) {
    super(__spreadProps(__spreadValues({}, props), { id: props.id || uid2("webgl-device") }));
    ...
    const webglContextAttributes = __spreadValues({}, props.webgl);
    ...
    this.handle = gl;
    this.gl = gl;
    this.spectorJS = initializeSpectorJS(__spreadProps(__spreadValues({}, this.props), { gl: this.handle }));
...
//# sourceMappingURL=chunk-VSIY6N4U.js.map
